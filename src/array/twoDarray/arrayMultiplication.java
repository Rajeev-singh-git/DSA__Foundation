...
public class arrayMultiplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("No of row in array.matrix " +a3.length);
        System.out.println("No of column in array.matrix " +a3[0].length);

        System.out.println("Multiply array.matrix");
